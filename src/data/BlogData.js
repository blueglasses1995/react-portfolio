...
export const Blogs = [
    {
        id:1,
        title:"Build Website with ReactJS, Styled-components and GSAP for Scrolling Animations",
    ...
    {
        id:2,
        title:"How to create React Hamburger Menu using Styled-Components",
    ...
    {
        id:3,
        title:"React Loading Screen: Try these 3 cool loading screens for your app",
    ...
    {
        id:4,
        title:"How to build a Fabulous Todo App using React, Redux and Framer-Motion",
    ...
    {
        id:5,
        title:"What is Higher Order Component (HOC) in React JS?",
